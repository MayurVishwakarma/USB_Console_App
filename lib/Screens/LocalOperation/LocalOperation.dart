...
class local_op_new extends StatefulWidget {
  local_op_new({Key? key}) : super(key: key);

  @override
  State<local_op_new> createState() => _local_op_newState();
}

class _local_op_newState extends State<local_op_new> {
  UsbPort? _port;
  String _status = "Idle";
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              SizedBox(
                                                                                ...
                                                                                child: Container(
                                                                                  decoration: BoxDecoration(color: Color.fromARGB(255, 223, 235, 247), borderRadius: BorderRadius.circular(5)),
                                                                                  child: Form(
                                                                                    key: _formKey,
                                                                                    child: Column(
                                                                                      children: [
                                                                                              ...
                                                                                              child: Padding(
                                                                                                ...
                                                                                                child: Row(
                                                                                                  ...
                                                                                                  children: [
                                                                                                    ElevatedButton(
                                                                                                      style: ButtonStyle(
                                                                                                        backgroundColor: MaterialStateProperty.all(modebtntxt == 'Auto' ? Colors.green : Colors.blue),
                                                                                                        minimumSize: MaterialStateProperty.all(Size(30, 30)), // Adjust the button size here
                                                                                                      ),
                                                                                                      onPressed: () {
                                                                                                        setState(() {
                                                                                                          modebtntxt = 'Auto';
                                                                                                      ...
                                                                                                      child: Text(
                                                                                                        'AUTO',
                                                                                                        style: TextStyle(color: Colors.white, fontSize: 10), // Adjust the button font size here
                                                                                                      ),
                                                                                                    ),
                                                                                                    ElevatedButton(
                                                                                                      style: ButtonStyle(
                                                                                                        backgroundColor: MaterialStateProperty.all(modebtntxt == 'Manual' ? Colors.green : Colors.blue),
                                                                                                        minimumSize: MaterialStateProperty.all(Size(30, 30)), // Adjust the button size here
                                                                                                      ),
                                                                                                      onPressed: () {
                                                                                                        setState(() {
                                                                                                    ...
                                                                                                    ElevatedButton(
                                                                                                      style: ButtonStyle(
                                                                                                        backgroundColor: MaterialStateProperty.all(modebtntxt == 'Test' ? Colors.green : Colors.blue),
                                                                                                        minimumSize: MaterialStateProperty.all(Size(30, 30)), // Adjust the button size here
                                                                                                      ),
                                                                                                      onPressed: () {
                                                                                                        showDialog(
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  ElevatedButton(
                                                                                                    style: ButtonStyle(
                                                                                                      backgroundColor: MaterialStateProperty.all(btnName == 'Flow Control' ? Colors.green : Colors.blue),
                                                                                                      minimumSize: MaterialStateProperty.all(Size(30, 30)), // Adjust the button size here
                                                                                                    ),
                                                                                                    onPressed: () {
                                                                                                      setState(() {
                                                                                                  ...
                                                                                                  ElevatedButton(
                                                                                                    style: ButtonStyle(
                                                                                                      backgroundColor: MaterialStateProperty.all(btnName == 'Position' ? Colors.green : Colors.blue),
                                                                                                      minimumSize: MaterialStateProperty.all(Size(30, 30)), // Adjust the button size here
                                                                                                    ),
                                                                                                    onPressed: () {
                                                                                                      setState(() {
                                                                                                  ...
                                                                                                  ElevatedButton(
                                                                                                    style: ButtonStyle(
                                                                                                      backgroundColor: MaterialStateProperty.all(btnName == 'Open/Close' ? Colors.green : Colors.blue),
                                                                                                      minimumSize: MaterialStateProperty.all(Size(30, 30)), // Adjust the button size here
                                                                                                    ),
                                                                                                    onPressed: () {
                                                                                                      setState(() {
                                                                                                        ...
                                                                                                        Padding(
                                                                                                          ...
                                                                                                          child: Row(
                                                                                                            ...
                                                                                                            children: [
                                                                                                              ElevatedButton(
                                                                                                                style: ButtonStyle(
                                                                                                                  backgroundColor: MaterialStateProperty.all(openclosetbnname == 'Open' ? Colors.green : Colors.blue),
                                                                                                                  minimumSize: MaterialStateProperty.all(Size(50, 30)), // Adjust the button size here
                                                                                                                ),
                                                                                                                onPressed: () {
                                                                                                                  setState(() {
                                                                                                              ...
                                                                                                              ElevatedButton(
                                                                                                                style: ButtonStyle(
                                                                                                                  backgroundColor: MaterialStateProperty.all(openclosetbnname == 'Close' ? Colors.red : Colors.blue),
                                                                                                                  minimumSize: MaterialStateProperty.all(Size(50, 30)), // Adjust the button size here
                                                                                                                ),
                                                                                                                onPressed: () {
                                                                                                                  setState(() {
                                                                                                              ...
                                                                                                              ElevatedButton(
                                                                                                                style: ButtonStyle(
                                                                                                                  backgroundColor: MaterialStateProperty.all(openclosetbnname == 'Stop' ? Colors.red : Colors.blue),
                                                                                                                  minimumSize: MaterialStateProperty.all(Size(50, 30)), // Adjust the button size here
                                                                                                                ),
                                                                                                                onPressed: () {
                                                                                                                  setState(() {
                                                                                              ...
                                                                                              Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  ElevatedButton(
                                                                                                    ...
                                                                                                    child: Text(
                                                                                                      'Set',
                                                                                                      style: TextStyle(color: Colors.white, fontSize: 12), // Adjust the button font size here
                                                                                                    ),
                                                                                                  ),
                                                                                                ],
                                                                                              ),
...
*/
  ...
  setControllMode6(int index) async {
    await SetMode6(index);
    await Future.delayed(Duration(seconds: 8)).whenComplete(() async {
      await setOpreationType6(index, btnName);
    });
  }

  setOpreationType6(int index, String mode) {
    if (mode.contains('Open/Close')) {
      ...
      new Future.delayed(Duration(seconds: 5))
          .whenComplete(() => setOpenCloseMode6(openclosetbnname, index));
      ...
      String data =
          ('PFCMD6TYPE $index 3 ' + _positioncontroller.text).toUpperCase() +
              "\r\n";
      _port!.write(Uint8List.fromList(data.codeUnits));
      new Future.delayed(Duration(seconds: 5)).whenComplete(() {
        String res = _data.join('');
  ...
  SetMode6(int index) async {
    if (modebtntxt == 'Auto') {
      String data = 'SMODE $index 1 1 1'.toUpperCase() + "\r\n";
      await _port!.write(Uint8List.fromList(data.codeUnits));
      ...
      String data =
          ('SMODE $index 3 1' + _datetimecontroller.text).toUpperCase() +
              "\r\n";
      await _port!.write(Uint8List.fromList(data.codeUnits));
    }
  }

  setOpenCloseMode6(String mode, int index) {
    if (mode == 'Open') {
      ...
      String data = ('PFCMD6ONOFF $index 2').toUpperCase() + "\r\n";
      _port!.write(Uint8List.fromList(data.codeUnits));
      new Future.delayed(Duration(seconds: 5)).whenComplete(() {
        String res = _data.join('');
        if (res.toLowerCase().contains('matched')) {
  ...
  setControllMode() async {
    getpop_loader(context);
    _startTask(18).whenComplete(() {
      Navigator.pop(context);
    });
    await SetMode();
    await Future.delayed(Duration(seconds: 8)).whenComplete(
      () {
