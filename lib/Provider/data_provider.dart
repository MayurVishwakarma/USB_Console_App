...
class DataProvider extends ChangeNotifier {
  ...
  setRMSValveOpenPFCMD6(int index) {
    String data = ('PFCMD1ONOFF 1').toUpperCase();
    updateCurrentIndex(index);
    sendMessage(data);
  }

  setRMSSovOpneclose(int index) {
    try {
      String message = 'PFCMD1TYPE 1'.toUpperCase();
      updateCurrentIndex(index);
      sendMessage(message);
    } catch (e) {
      print(e);
  ...
  setRMSValveClosePFCMD6(int index) {
...
// 6 pfcnd data
  ...
  getPT2value() {
    try {
      ...
      print('Is OutletPt-2 between 2.25 and 2.75? $isWithinRange');
...
/*
  ...
  getPT3value() {
    try {
      ...
      print('Is OutletPt-3 between 2.25 and 2.75? $isWithinRange');
  ...
  getPT4value() {
    try {
      ...
      print('Is OutletPt-4 between 2.25 and 2.75? $isWithinRange');
  ...
  getPT5value() {
    try {
      ...
      print('Is OutletPt-5 between 2.25 and 2.75? $isWithinRange');
  ...
  getPT6value() {
    try {
      ...
      print('Is OutletPt-6 between 2.25 and 2.75? $isWithinRange');
